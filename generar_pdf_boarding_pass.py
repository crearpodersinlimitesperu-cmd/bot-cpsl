...
def generar_pdf_boarding_pass_final():
    pdf = ContratoPDF()
    pdf.add_page()
    ...
    clausulas = [
        ...
        "5. Responsabilidad civil y conducta: CREACION CUANTICA se reserva el derecho de admision y permanencia. Conductas violentas generan retiro inmediato.",
        "6. Confidencialidad: Prohibida la grabacion o difusion de dinamicas y testimonios.",
        "7. Uso de imagen y proteccion de datos: Autorizacion para fines institucionales. Tratamiento conforme a la Ley N 29733.",
        "8. Aceptacion Digital: El participante declara haber aceptado estos terminos mediante el formulario oficial de inscripcion.",
        "9. Validez Contractual: Este documento constituye manifestacion valida de voluntad conforme a la legislacion peruana."
    ]
    ...
    pdf.cell(0, 5, f'  Generado automaticamente por el sistema interno de inscripcion.', 0, 1)
    pdf.cell(0, 5, f'  Fecha de Registro: {fecha} | Hora: {hora}', 0, 1)
    pdf.set_font('Arial', 'B', 8)
    pdf.cell(0, 5, '  ESTADO: CONTRATO ACEPTADO DIGITALMENTE - VALIDADO', 0, 1)
    
    output_path = r"C:\Users\josem\Downloads\bot-cpsl-review\Contrato_BoardingPass_ROCIO_JARA.pdf"
    pdf.output(output_path)
    print(f"PDF Boarding Pass generado en: {output_path}")

if __name__ == "__main__":
    generar_pdf_boarding_pass_final()
